...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Révisions incluses en phase de lancement",
    ],
    cta: "S'inspirer",
    href: "/productions",
    featured: true,
...
export function PricingPlans() {
  return (
    <div
      className="relative -mt-28 min-h-screen overflow-hidden pb-24 pt-28 sm:-mt-32 sm:pb-28 sm:pt-32"
      style={{
        background: `
          radial-gradient(ellipse 110% 75% at 50% -8%, rgba(124,58,237,0.30) 0%, rgba(124,58,237,0.10) 42%, rgba(124,58,237,0.03) 58%, #f8f6fc 78%),
          linear-gradient(180deg, #ebe4f7 0%, #f3effb 28%, #f8f6fc 55%, #f8f6fc 100%)
        `,
      }}
    >
          ...
          {plans.map((plan, i) => {
            ...
            return (
              <motion.article
                ...
                className={`relative flex flex-col rounded-2xl border bg-white p-6 shadow-[0_8px_30px_-12px_rgba(15,23,42,0.08),0_2px_8px_-4px_rgba(15,23,42,0.04)] sm:p-7 ${
                  isFeatured
